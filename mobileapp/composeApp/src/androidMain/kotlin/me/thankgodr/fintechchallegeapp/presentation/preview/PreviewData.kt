...
internal object PreviewData {
    ...
    val filledPaymentState = SendPaymentState(
        recipientEmail = "alice@example.com",
        amount = "250.00",
        senderName = "John Doe",
    ...
    val paymentStateWithErrors = SendPaymentState(
    ...
    val loadingPaymentState = SendPaymentState(
        recipientEmail = "alice@example.com",
        amount = "100.00",
        senderName = "John",
        isLoading = true,
    ...
    val transactionHistoryState = TransactionHistoryState(
        transactions = sampleTransactions,
        isLoading = false
    )

    val emptyHistoryState = TransactionHistoryState(
    ...
    val errorHistoryState = TransactionHistoryState(
        isLoading = false,
