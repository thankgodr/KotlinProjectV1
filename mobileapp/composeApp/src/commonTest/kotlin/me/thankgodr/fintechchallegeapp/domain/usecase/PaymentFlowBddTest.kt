...
class PaymentFlowBddTest {
    ...
    private val completedTransaction = Transaction(
        id = "tx-bdd-1",
    ...
    @Test
    fun givenValidDetails_whenSendingPayment_thenPaymentSucceeds() = runTest {
    ...
    @Test
    fun givenInvalidEmail_whenSendingPayment_thenPaymentIsRejected() = runTest {
    ...
    @Test
    fun givenZeroAmount_whenSendingPayment_thenPaymentIsRejected() = runTest {
        val repo = FakeRepository(Result.success(completedTransaction))
        val sendPayment = SendPaymentUseCase(repo)
    ...
    @Test
    fun givenNetworkError_whenSendingPayment_thenPaymentFails() = runTest {
    ...
    @Test
    fun givenUnsupportedCurrency_whenSendingPayment_thenPaymentIsRejected() = runTest {
        val repo = FakeRepository(Result.success(completedTransaction))
        val sendPayment = SendPaymentUseCase(repo)
