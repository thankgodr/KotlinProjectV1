...
class PaymentRepositoryImplTest {
    ...
    @Test
    fun sendPayment_successResponse_returnsDomainTransaction() =
        runTest {
    ...
    @Test
    fun sendPayment_successResponse_savesToFirestore() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val repo =
                TestableRepository(
    ...
    @Test
    fun sendPayment_firestoreFails_stillReturnsSuccess() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val repo =
                TestableRepository(
    ...
    @Test
    fun sendPayment_apiReturnsErrors_returnsFailure() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val repo =
                TestableRepository(
    ...
    @Test
    fun sendPayment_apiThrowsException_returnsFailure() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val repo =
                TestableRepository(
    ...
    @Test
    fun sendPayment_apiReturnsNullData_returnsFailure() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val repo =
                TestableRepository(
    ...
    @Test
    fun observeTransactions_mapsDtosToDomain() =
        runTest {
            val testScope = TestScope(UnconfinedTestDispatcher(testScheduler))
            val dtos =
                listOf(
