...
class SendPaymentUseCaseTest {
    ...
    @Test
    fun validPayment_callsRepositoryAndReturnsSuccess() = runTest {
    ...
    @Test
    fun invalidEmail_returnsValidationFailure_doesNotCallRepository() = runTest {
        val repo = FakeRepository(Result.success(successTransaction))
        val useCase = SendPaymentUseCase(repo)
    ...
    @Test
    fun zeroAmount_returnsValidationFailure() = runTest {
        val repo = FakeRepository(Result.success(successTransaction))
        val useCase = SendPaymentUseCase(repo)
    ...
    @Test
    fun emptySenderName_returnsValidationFailure() = runTest {
        val repo = FakeRepository(Result.success(successTransaction))
        val useCase = SendPaymentUseCase(repo)
    ...
    @Test
    fun unsupportedCurrency_returnsValidationFailure() = runTest {
        val repo = FakeRepository(Result.success(successTransaction))
        val useCase = SendPaymentUseCase(repo)
    ...
    @Test
    fun multipleValidationErrors_returnsAll() = runTest {
        val repo = FakeRepository(Result.success(successTransaction))
        val useCase = SendPaymentUseCase(repo)
    ...
    @Test
    fun repositoryFailure_propagatesError() = runTest {
