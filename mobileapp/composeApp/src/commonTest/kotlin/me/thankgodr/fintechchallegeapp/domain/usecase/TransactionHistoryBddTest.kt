...
class TransactionHistoryBddTest {
    ...
    private fun tx(id: String, email: String, amount: Double, status: TransactionStatus = TransactionStatus.COMPLETED) =
        Transaction(
            id = id,
    ...
    @Test
    fun givenTransactionsExist_whenObserving_thenTransactionsAreEmitted() = runTest {
        val existing = listOf(
    ...
    @Test
    fun givenNoTransactions_whenObserving_thenEmptyListIsEmitted() = runTest {
    ...
    @Test
    fun givenObserving_whenNewTransactionArrives_thenListUpdates() = runTest {
        ...
        val job = testScope.backgroundScope.launch(UnconfinedTestDispatcher(testScheduler)) {
    ...
    @Test
    fun givenMixedStatuses_whenObserving_thenAllStatusesArePresent() = runTest {
    ...
    @Test
    fun givenTransactions_whenObserving_thenAmountsAndDetailsAreCorrect() = runTest {
        val transactions = listOf(
            Transaction(
                id = "tx-eur",
